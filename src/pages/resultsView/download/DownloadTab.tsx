...
export default class DownloadTab extends React.Component<IDownloadTabProps, {}>
{
    ...
    public render() {
        ...
        return (
            <span className="cbioportal-frontend">
                <div>
                    <FeatureTitle
                                ...
                                handleTransposedMatrixDownload: () => void)
    {
        return (
            <tr>
                <td style={{width: 400}}>{title}</td>
                <td>
                    <a onClick={handleTabDelimitedDownload} style={{marginRight: 10}}>
                        Tab Delimited Format <i className='fa fa-cloud-download'/>
                    </a>
                    <a onClick={handleTransposedMatrixDownload}>
                        Transposed Matrix <i className='fa fa-cloud-download'/>
                    </a>
                </td>
            </tr>
        );
