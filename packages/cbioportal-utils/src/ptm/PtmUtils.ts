...
function getResiduesFromUniportFeature(ptm: UniprotFeature) {
    return {
...
export function getPubmedIdsFromUniportFeature(ptm: UniprotFeature) {
...
export function getPtmTypeFromUniportFeature(ptm: UniprotFeature) {
    ...
    return ptmType || PtmType.Other;
}

export function getPtmDescriptionFromUniportFeature(ptm: UniprotFeature) {
...
export function convertUniprotFeatureToPtm(
    ...
    return {
        type: getPtmTypeFromUniportFeature(ptm),
        residue: getResiduesFromUniportFeature(ptm),
        pubmedIds: getPubmedIdsFromUniportFeature(ptm),
        description: getPtmDescriptionFromUniportFeature(ptm),
    };
}
